...
function changeImage() {
    ...
    if (document.getElementById("imgClickAndChange").src.includes( "ro.png")){
        document.getElementById("imgClickAndChange").src = "resurse/images/gb.png";
    } else {
        document.getElementById("imgClickAndChange").src = "resurse/images/ro.png";
    }
}
function changeText(clicked_id) {
    ...
    document.getElementById("nextButton").href = "/branches";
...
function printmsg() {
  ...
  if (usr_input == captcha.innerHTML) {
    var s = (document.getElementById("key").innerHTML = "Cod corect");
    location.replace("/subjectOptions");
  } else {
    var s = (document.getElementById("key").innerHTML = "Cod greșit");
    generate();
  }
}